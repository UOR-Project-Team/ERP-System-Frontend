...
export const generatePDFGRN = (
  ...
  function footerText(){
   ...
   const SupplierDetails = function(data ){  
    ...
    pdf.text(`${selectedSupplierContact}`, 140, 165);
   ...
   const addTransactionTabel = (pdf , subTotal , discount , totalAmount) =>{
    ...
    pdftext1();
    pdf.text(thankYouMessage, 270, pdf.autoTable.previous.finalY + marginAdjustment + 100);
